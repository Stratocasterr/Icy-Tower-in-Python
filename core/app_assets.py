...
class AppAssets: #"D:\Python_programy\Icy_Tower\Icy-Tower-in-Python\assets"
    ...
    background = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/shittyimage.png")
    frame = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/Uriziel.png")
    ...
    frame = pygame.image.load("assets/Uriziel.png")'''