...
class AppAssets: #"D:\Python_programy\Icy_Tower\Icy-Tower-in-Python\assets"
    ...
    # background = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/background.jpg")
    # frame = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/frame_right.png")
    # frame_1 = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/frame_left.png")



    # platform_sign = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/platform_sign.png")  # jacek dodaj sobie to
    # main_menu_pic = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/menu.png")
    # main_start_but = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/menu_start_game.png")
    # main_help_but = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/menu_help.png")
    # main_quit_but = pygame.image.load("D:/Python_programy/Icy_Tower/Icy-Tower-in-Python/assets/menu_quit.png")
    ...
    frame = pygame.image.load("assets/frame_right.png")
    frame_1 = pygame.image.load("assets/frame_left.png")
    platform_sign = pygame.image.load("assets/platform_sign.png")  # jacek dodaj sobie to
    main_menu_image = pygame.image.load("assets/menu.png")
    main_start_button = pygame.image.load("assets/menu_start_game.png")
    main_help_button = pygame.image.load("assets/menu_help.png")
    main_quit_button = pygame.image.load("assets/menu_quit.png")
